/**
 * إعدادات هوية الشركة المستخدمة في رأس مستندات الطباعة (Charly Group).
 *
 * COMPANY_LOGO: مسار صورة اللوجو. ضع صورة اللوجو في مجلد `front/public/images/`
 * باسم `charly-group-logo.png` (أو أي اسم آخر) ثم عدّل المسار هنا فقط —
 * لا حاجة لتعديل أي مكان آخر في الكود.
 *
